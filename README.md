...
The tool is free, but requires your own API key. API usage costs approximately $1USD for ~ 150 PDFs using the Deepseek AI. Currently, the tool supports Deepseek but other AI vendors will be added. 
